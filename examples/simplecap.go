...
*
* Note: pfring should already be installed on your system
*
* To get - go get github.com/marv2097/gopfring
* To build - go install github.com/marv2097/gopfring/examples/simplecap
* To run - sudo $GOPATH/bin/simplecap -i eth2 -c 1
*
*/
